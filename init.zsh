...
zsh "$DOTFILE_DIR/system/install.zsh"     # Install rosetta 2
zsh "$DOTFILE_DIR/security/install.zsh"   # Install security tools
zsh "$DOTFILE_DIR/vim/install.zsh"        # Set up vim
zsh "$DOTFILE_DIR/git/install.zsh"        # Set up git
zsh "$DOTFILE_DIR/github/install.zsh"     # Set up GitHub
zsh "$DOTFILE_DIR/zsh/install.zsh"        # Set up zsh
